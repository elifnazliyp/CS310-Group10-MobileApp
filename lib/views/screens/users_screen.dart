...
import 'package:firebase_crud_app/models/notification.dart';
              ...
              children: [
                ...
                Flexible(
                  child: RichText(text: TextSpan(
                    children: [
                      TextSpan(text: notification.name, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                      TextSpan(text: notification.content, style: TextStyle(color: Colors.white)),
